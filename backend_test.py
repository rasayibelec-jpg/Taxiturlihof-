...
class BackendTester:
    ...
    async def test_cors_headers(self):
        ...
        try:
            ...
            headers = {
                "Origin": "https://nova-taxi-portal.preview.emergentagent.com",
            ...
            async with self.session.options(
                ...
                cors_ok = (
                    cors_headers["access-control-allow-origin"] in ["*", "https://nova-taxi-portal.preview.emergentagent.com"] and
