...
const TaxiRothenThurmPage = () => {
  return (<><Helmet><title>Taxi Rothenthurm – Taxi Turlihof | Flughafentransfer</title><meta name="description" content="Taxi Turlihof - Ihr Taxi-Service in Rothenthurm. Flughafentransfer. Jetzt buchen: 076 611 31 31" /><link rel="canonical" href="https://www.taxiturlihof.ch/taxi-rothenthurm" /></Helmet>
