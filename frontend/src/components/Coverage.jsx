    ...
    <section id="coverage" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            <a href="https://www.taxiturlihof.ch/servicegebiet/weggis-vitznau" className="block">
              <Card className="group hover:shadow-xl transition-all duration-300 transform hover:scale-105 border-gray-200 mb-4 cursor-pointer">
                <CardHeader className="pb-4">
          ...
          <div className="text-center">
            <a href="https://www.taxiturlihof.ch/servicegebiet/schwyz-brunnen" className="block">
              <Card className="group hover:shadow-xl transition-all duration-300 transform hover:scale-105 border-gray-200 mb-4 cursor-pointer">
                <CardHeader className="pb-4">
          ...
          <div className="text-center">
            <a href="https://www.taxiturlihof.ch/servicegebiet/zug" className="block">
              <Card className="group hover:shadow-xl transition-all duration-300 transform hover:scale-105 border-gray-200 mb-4 cursor-pointer">
                <CardHeader className="pb-4">
            ...
            <a 
              href="https://www.google.com/maps/place/Zug,+Switzerland" 
              target="_blank" 
              rel="noopener noreferrer"
          ...
          <div className="text-center">
            <a href="https://www.taxiturlihof.ch/servicegebiet/arth-goldau" className="block">
              <Card className="group hover:shadow-xl transition-all duration-300 transform hover:scale-105 border-gray-200 mb-4 cursor-pointer">
                <CardHeader className="pb-4">
