...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 text-white py-12 border-t border-yellow-500/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            {/* SOCIAL MEDIA BUTTONS - SICHTBAR UND MIT TIKTOK */}
            <div className="mb-6">
              ...
              <div className="flex space-x-4">
                ...
                <a
                  ...
                  className="bg-green-500 hover:bg-green-600 p-3 rounded-full transition-all duration-200 transform hover:scale-110"
                  title="WhatsApp"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 p-3 rounded-full transition-all duration-200 transform hover:scale-110"
                  title="Instagram"
                >
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                {/* TikTok - NEU HINZUGEFÜGT */}
                <a
                  href="https://www.tiktok.com/@taxiturlihof"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-black hover:bg-gray-800 p-3 rounded-full transition-all duration-200 transform hover:scale-110"
                  title="TikTok"
                >
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
