...
const FloatingActionButtons = () => {
  ...
  return (
    <div className="fixed bottom-6 left-6 z-50">
      ...
      {/* Quick Phone Button (Always Visible) - Next to Plus Button */}
      <div className="absolute bottom-6 left-20">
        <Button
          onClick={handlePhoneCall}
          className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 group"
        >
      ...
      <div className="absolute bottom-6 left-72">
        <Button
          onClick={handleWhatsApp}
          className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 group flex items-center"
          style={{ backgroundColor: '#25D366', borderColor: '#25D366' }}
          onMouseEnter={(e) => e.target.style.backgroundColor = '#128C7E'}
          onMouseLeave={(e) => e.target.style.backgroundColor = '#25D366'}
        >
