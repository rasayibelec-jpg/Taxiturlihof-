        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-900 to-black">
          <div className="max-w-7xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white">
              Taxi Root – Schnell & Zuverlässig
            </h1>
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Ihr Taxi-Service in Root, Luzern
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gray-900 rounded-lg shadow-xl p-8 mb-12">
              <h2 className="text-3xl font-bold mb-6 text-white">
                Taxi & Flughafentransfer in Root
              </h2>
              <p className="text-lg text-gray-300 leading-relaxed mb-6">
                Taxi Turlihof bietet in Root einen professionellen und pünktlichen Taxi-Service. 
                Ob Flughafentransfer, Stadtfahrten oder längere Strecken – wir sind Ihr verlässlicher Partner.
              </p>
              ...
              <div className="grid md:grid-cols-3 gap-6 mt-8">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Klare Kosten</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Verlässlich</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">In Root</p>
                  </div>
                </div>
              </div>
            </div>
